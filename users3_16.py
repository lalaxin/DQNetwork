"""
data3_12-14-sheet2   12:00-14:00  十分钟时间间隔 用户数据存在regionminute10_12-14.xlsx中
"""
import xlrd,xlwt
import datetime
import random
...
class getuser_15():
    def getusers(self):
        ...
        excel = xlrd.open_workbook("./data3_12-14.xlsx")

        # 获取excel的sheet表
        sheet = excel.sheet_by_name("Sheet2")
        starttime = datetime.datetime(2016, 8, 1, 12, 00, 00)
        endtime = datetime.datetime(2016, 8, 1, 12, 10, 00)
...
def getregion():
    ...
    data=pd.DataFrame(init_region)
        # 写入excel文件
    writer=pd.ExcelWriter("./regionminute10_12-14.xlsx")
